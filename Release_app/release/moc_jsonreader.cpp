...
#include "../../../Documents/ClientTCPv2/jsonreader.h"
...
QT_MOC_LITERAL(3, 20, 8) // "received"

    },
    "JsonReader\0display\0\0received"
};
...
void JsonReader::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->received((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            using _t = void (JsonReader::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&JsonReader::display)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void JsonReader::display(QString _t1)
{
